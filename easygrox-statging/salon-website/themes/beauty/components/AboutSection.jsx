...
const galleryImageFiles = [
  ...
  { file: 'Rectangle 31.png', alt: 'Salon ambience 5' },
...
export default function AboutSection() {
  ...
  return (
    <section id="about" className="w-full bg-[#F5ECE7] relative overflow-hidden">
      {/* Main Content Area */}
      <div className="relative w-full bg-[#F5ECE7] py-20 overflow-hidden">
        <div className="max-w-[1360px] mx-auto px-4 relative z-25">
          ...
          <div className="w-full lg:w-[55%] relative z-20 mx-auto text-center lg:text-left">
            ...
            <p className="text-text-secondary font-inter font-light text-base md:text-lg leading-relaxed mb-12 max-w-[777px] mx-auto lg:mx-0">
              At our salon, beauty is more than appearance. It’s about
              confidence, comfort, and self-expression. Our expert stylists and
              beauty professionals offer personalized services using premium
              products and modern techniques to help you look and feel your
              best. From everyday glam to special occasions, we create
              experiences that leave you refreshed, radiant, and confident.
            </p>
            ...
            <div className="flex items-center justify-center lg:justify-start gap-8 md:gap-14">
              ...
              {/* Divider */}
              <div className="w-px h-[90px] md:h-[110px] bg-[#F5ECE7]/50"></div>
        ...
        <div className="absolute -left-0 top-0 w-[380px] h-[680px] pointer-events-none opacity-30 lg:opacity-100 transition-opacity">
          <img
            src={assetUrl('assets/comb-removebg-preview 1.png')}
            alt="Decoration Left"
        ...
        <div className="absolute -right-0 top-0 w-[380px] h-[680px] pointer-events-none opacity-30 lg:opacity-100 transition-opacity">
          <img
            src={assetUrl('assets/girl-removebg-preview 2.png')}
