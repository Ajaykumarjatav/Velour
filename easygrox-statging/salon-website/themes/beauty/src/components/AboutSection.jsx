...
function GalleryImage({ src, alt, fallbackSrc }) {
  return (
    <img
      ...
      className="w-full bg-[#F5ECE7] relative overflow-hidden"
    />
  )
}
...
export default function AboutSection() {
  ...
  return (
    <section id="about" className="relative w-full bg-bg-[#F5ECE7]-light py-20 overflow-hidden">
      {/* Main Content Area */}
      <div className="w-px h-[90px] md:h-[110px] bg-bg-[#F5ECE7]">
