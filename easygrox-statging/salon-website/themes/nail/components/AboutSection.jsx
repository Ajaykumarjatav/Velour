...
export default function AboutSection() {
  ...
  return (
    <section
      id="about"
      className="w-full bg-[#F8F8F8] relative overflow-hidden"
    >
      {/* Main Content Area */}
      <div className="relative w-full bg-[#F8F8F8] py-20 overflow-hidden">
        <div className="max-w-[1360px] mx-auto px-4 relative z-25">
          ...
          <div className="w-full lg:w-[55%] relative z-20 mx-auto text-center lg:text-left">
            ...
            <p className="text-text-secondary font-inter font-light text-base md:text-lg leading-relaxed mb-12 max-w-[777px] mx-auto lg:mx-0">
              Where beauty meets artistry, we create nail experiences that feel
              elegant, relaxing, and uniquely personal. Our studio is dedicated
              to delivering timeless nail designs, premium care, and a luxurious
              atmosphere that helps every client feel confident and pampered.
              From classic manicures to modern nail art, every detail is crafted
            ...
            <div className="flex items-center justify-center lg:justify-start gap-8 md:gap-14">
              ...
              {/* Divider */}
              <div className="w-px h-[90px] md:h-[110px] bg-[#F8F8F8]/50"></div>
        ...
        <div className="absolute -left-0 top-0 w-[380px] h-[680px] pointer-events-none opacity-30 lg:opacity-100 transition-opacity">
          <img
            src={assetUrl('assets/background-removebg-preview 1.png')}
            alt="Decoration Left"
        ...
        <div className="absolute -right-0 top-0 w-[380px] h-[680px] pointer-events-none opacity-30 lg:opacity-100 transition-opacity">
          <img
            src={assetUrl('assets/Circular Text SVG Element.png')}
