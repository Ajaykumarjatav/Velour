...
<div class="w-full bg-black py-4 md:py-5 px-4 border-b border-white/10">
        ...
        <div class="flex flex-col sm:flex-row items-center gap-4 lg:gap-10">
            ...
            @if(!empty($salon['phone']))
                <a
                    ...
                    class="flex items-center gap-2 text-white hover:text-salmon transition-colors duration-300 outline-none focus-visible:ring-2 focus-visible:ring-salmon focus-visible:ring-offset-2 focus-visible:ring-offset-black rounded-md px-2.5 py-1.5 bg-white/5 hover:bg-white/10 border border-white/10"
                    aria-label="Call {{ $salon['phone'] }}"
                >
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
                        <path d="M6.62 10.79c1.44 2.83 3.76 5.14 6.59 6.59l2.2-2.2c.27-.27.67-.36 1.02-.24 1.12.37 2.33.57 3.57.57.55 0 1 .45 1 1V20c0 .55-.45 1-1 1-9.39 0-17-7.61-17-17 0-.55.45-1 1-1h3.5c.55 0 1 .45 1 1 0 1.25.2 2.45.57 3.57.11.35.03.74-.25 1.02l-2.2 2.2z" />
                    </svg>
                    <span class="font-semibold text-xs md:text-sm whitespace-nowrap">{{ $salon['phone'] }}</span>
                </a>
            @endif
        </div>
    </div>
