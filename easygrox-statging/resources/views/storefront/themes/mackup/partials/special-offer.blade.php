<section class="w-full bg-[#F2EBE8] py-16 lg:py-20 overflow-hidden">
    <div class="max-w-[1360px] mx-auto px-4">
        <div class="relative rounded-[32px] overflow-hidden bg-deep-[#b7846a] min-h-[360px] md:min-h-[400px] flex items-center shadow-xl">
