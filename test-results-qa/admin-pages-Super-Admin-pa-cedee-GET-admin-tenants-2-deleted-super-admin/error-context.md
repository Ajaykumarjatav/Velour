...
- Name: admin-pages.spec.ts >> Super Admin pages (plan SA-*) >> SA-09n GET /admin/tenants/2/deleted
- Location: tests\playwright\admin-pages.spec.ts:44:5

# Error details

```
Error: SA-09n admin/tenants/2/deleted status
      ...
      - generic [ref=e29]:
        - generic [ref=e31]:
          ...
          - generic [ref=e41]:
            ...
            - button "C:\\xampp\\htdocs\\vellor\\admin\\resources\\views\\admin\\tenants\\deleted\\index.blade.php :32 require" [ref=e210] [cursor=pointer]:
              - generic [ref=e212]:
                - generic [ref=e214]:
                  - generic [ref=e215]: C:\xampp\htdocs\vellor\admin\resources\views\admin\tenants\deleted\index.blade.php
                  - generic [ref=e216]: :32
      ...
      - generic [ref=e896]:
        ...
        - generic [ref=e899]:
          - generic [ref=e900]:
            ...
            - code [ref=e904]: App\Http\Controllers\Admin\Tenant\AdminTenantDeletedController@index
          - generic [ref=e905]:
            - generic [ref=e906] [cursor=pointer]: route name
            - code [ref=e909]: admin.tenants.deleted.index
          - generic [ref=e910]:
        ...
        - generic [ref=e922]:
          - generic [ref=e923]:
            - generic [ref=e924]:
              - text: mysql
              - generic [ref=e925]: (5.05 ms)
            - code [ref=e928]: "select * from `users` where `id` = 1 and `users`.`deleted_at` is null limit 1"
          - generic [ref=e929]:
            - generic [ref=e930]:
              - text: mysql
              - generic [ref=e931]: (1.05 ms)
            - code [ref=e934]: "select * from `salons` where `salons`.`id` = 2 limit 1"
          - generic [ref=e935]:
            - generic [ref=e936]:
              - text: mysql
              - generic [ref=e937]: (1.8 ms)
            - code [ref=e940]: "insert into `audit_logs` (`user_id`, `user_email`, `user_name`, `salon_id`, `event`, `event_category`, `severity`, `description`, `subject_type`, `subject_id`, `metadata`, `ip_address`, `user_agent`, `session_id`, `request_id`, `http_method`, `url`, `occurred_at`) values (1, 'admin@velour.app', 'Velour Admin', 2, 'admin.tenant.view', 'admin', 'warning', 'Admin viewed deleted.index list for salon 'ak salon'', 'App\\Models\\Salon', 2, '{\"module\":\"deleted.index\",\"salon_id\":2}', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.7922.34 Safari/537.36', 'EVylLVZnikIxF2MdWsshwm23DmppHzyCjf8oYXN1', NULL, 'GET', 'http://localhost/admin/tenants/2/deleted', '2026-08-09 12:38:25')"
          - generic [ref=e941]:
            - generic [ref=e942]:
              - text: mysql
              - generic [ref=e943]: (1.03 ms)
            - code [ref=e946]: "select * from `clients` where `clients`.`deleted_at` is not null and `salon_id` = 2 order by `deleted_at` desc limit 20"
          - generic [ref=e947]:
            - generic [ref=e948]:
              - text: mysql
              - generic [ref=e949]: (2.31 ms)
            - code [ref=e952]: "select * from `staff` where `staff`.`deleted_at` is not null and `salon_id` = 2 order by `deleted_at` desc limit 20"
          - generic [ref=e953]:
            - generic [ref=e954]:
              - text: mysql
              - generic [ref=e955]: (1.28 ms)
            - code [ref=e958]: "select * from `services` where `services`.`deleted_at` is not null and `salon_id` = 2 order by `deleted_at` desc limit 20"
          - generic [ref=e959]:
            - generic [ref=e960]:
              - text: mysql
              - generic [ref=e961]: (3.58 ms)
            - code [ref=e964]: "select * from `service_packages` where `service_packages`.`deleted_at` is not null and `salon_id` = 2 order by `deleted_at` desc limit 20"
          - generic [ref=e965]:
            - generic [ref=e966]:
              - text: mysql
              - generic [ref=e967]: (2.87 ms)
            - code [ref=e970]: "select * from `inventory_items` where `inventory_items`.`deleted_at` is not null and `salon_id` = 2 order by `deleted_at` desc limit 20"
          - generic [ref=e971]:
            - generic [ref=e972]:
              - text: mysql
              - generic [ref=e973]: (3.35 ms)
            - code [ref=e976]: "select * from `marketing_campaigns` where `marketing_campaigns`.`deleted_at` is not null and `salon_id` = 2 order by `deleted_at` desc limit 20"
          - generic [ref=e977]:
            - generic [ref=e978]:
              - text: mysql
              - generic [ref=e979]: (8.01 ms)
            - code [ref=e982]: "select * from `appointments` where `appointments`.`deleted_at` is not null and `salon_id` = 2 order by `deleted_at` desc limit 20"
          - generic [ref=e983]:
            - generic [ref=e984]:
              - text: mysql
              - generic [ref=e985]: (0.73 ms)
          ...
          - generic [ref=e1037]:
            - generic [ref=e1038]:
              - text: mysql
              - generic [ref=e1039]: (0.72 ms)
            - code [ref=e1042]: "select `salon_id` from `staff` where `user_id` = 1 and `deleted_at` is null limit 1"
          - generic [ref=e1043]:
            - generic [ref=e1044]:
              - text: mysql
              - generic [ref=e1045]: (1.01 ms)
            - code [ref=e1048]: "select * from `users` where `users`.`id` = 5 and `users`.`deleted_at` is null limit 1"
          - generic [ref=e1049]:
            - generic [ref=e1050]:
              - text: mysql
          ...
          - generic [ref=e1055]:
            - generic [ref=e1056]:
              - text: mysql
              - generic [ref=e1057]: (0.46 ms)
            - code [ref=e1060]: "select `salon_id` from `staff` where `user_id` = 1 and `deleted_at` is null limit 1"
          - generic [ref=e1061]:
            - generic [ref=e1062]:
              - text: mysql
              - generic [ref=e1063]: (2.09 ms)
            - code [ref=e1066]: "select count(*) as aggregate from `support_tickets` where `status` in ('open', 'in_progress') and `assigned_to` is null"
          - generic [ref=e1067]:
            - generic [ref=e1068]:
              - text: mysql
              - generic [ref=e1069]: (0.81 ms)
