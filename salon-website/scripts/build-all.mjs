...
console.log('  - Live (easygrox.com): copy deploy/public_html/.htaccess + s/ → public_html/')
console.log('  - Staging (/vellor): copy deploy/vellor/.htaccess + s/ → public_html/vellor/')
console.log('  - Staging: upload dist/ folder → public_html/vellor/dist/')
