...
export default function HeroSection() {
  ...
  return (
    ...
    >
      ...
      {/* Decorative circles */}
      <div className="absolute left-[-160px] top-[120px] w-[520px] h-[520px] rounded-full border border-[#b1adad] opacity-10 hidden lg:block"></div>
      <div className="absolute left-[-15px] top-[640px] w-[187px] h-[349px] border border-[#b1adad] rounded-br-[180px] opacity-10 hidden lg:block"></div>
      ...
      <div className="relative z-10 max-w-[1360px] mx-auto px-4 pt-16 md:pt-24 lg:pt-[80px] pb-24">
        <div className="max-w-[800px] text-center lg:text-left">
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(93deg, #b1a1dad 2.49%, #b1adad 96.02%, #b1adad 184.57%)",
              border: "0.72px solid #b1adad",
            }}
          >
          ...
          {/* Consultation Items */}
          <div className="text-[#A5A5A5] font-inter font-light text-sm md:text-lg max-w-[500px] mb-8 md:mb-10 mx-auto lg:mx-0 leading-relaxed">
            {[1, 2, 3].map((_, i) => (
              <div
                key={i}
                className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-8 md:gap-12 mb-10 md:mb-12"
              >
                <div className="flex flex-col items-center lg:items-start gap-3 group/item cursor-default">
                  <svg
                    width="24"
                    height="24"
                    viewBox="0 0 35 35"
                  ...
                  >
                    <path
                      ...
                      fill="currentColor"
                      className="w-[50px] h-[50px] rounded-full bg-white/5 border border-white/10 flex items-center justify-center transition-all duration-300 group-hover/item:bg-primary/20 group-hover/item:border-primary/50 group-hover/item:scale-105"
                    />
                  </svg>
                </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 md:gap-6 w-full sm:w-auto">
            <BookButton
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2.5 bg-[#7a8b72] hover:bg-[#7a8b72]-dark text-white font-semibold text-sm md:text-base rounded-full px-8 py-4 transition-all duration-300 shadow-md hover:shadow-[#7a8b72]/20 hover:scale-[1.02] active:scale-[0.98] outline-none focus-visible:ring-2 focus-visible:ring-[#7a8b72] focus-visible:ring-offset-2 focus-visible:ring-offset-black"
            >
