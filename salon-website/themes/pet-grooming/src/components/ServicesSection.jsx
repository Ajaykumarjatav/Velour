  ...
  return (
    <section id="services" className="max-w-[1360px] mx-auto px-4">
      <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-12">
        {/* Header */}
        <div className="text-[#7a8b72] font-manrope font-semibold text-sm uppercase tracking-widest block mb-2">
        ...
        {services.length > 0 ? (
            ...
            {services.map((service) => (
              ...
              >
                <div className="flex flex-col gap-1">
                  ...
                  <div className="font-manrope font-bold text-base md:text-lg text-black transition-colors duration-300 group-hover/item:text-[#7a8b72]">
          ...
          <p className="inline-flex items-center justify-center gap-2.5 bg-[#7a8b72] hover:bg-[#7a8b72]-dark text-white font-manrope font-bold text-sm md:text-base uppercase tracking-wider rounded-full px-8 md:px-12 py-4 md:py-4.5 transition-all duration-300 shadow-md hover:shadow-[#7a8b72]y/20 hover:scale-[1.02] active:scale-[0.98] outline-none focus-visible:ring-2 focus-visible:ring-[#7a8b72]">
