...
export default function SpecialOfferBanner() {
  return (
    <section className="w-full bg-[#F5ECE7] py-16 lg:py-20 overflow-hidden">
      <div className="max-w-[1360px] mx-auto px-4">
        <div className="relative rounded-[32px] overflow-hidden bg-deep-[#c98f8f] min-h-[360px] md:min-h-[400px] flex items-center shadow-xl">
          ...
          <div className="absolute right-0 top-0 w-full md:w-[70%] h-full">
            <img src={assetUrl('assets/image 2.png')} alt="Salon special offer" className="w-full h-full object-contain opacity-30" />
          </div>
          ...
          <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between w-full px-6 sm:px-10 md:px-16 py-12 lg:py-10 gap-10 lg:gap-8">
            <div className="max-w-[550px] text-center lg:text-left flex flex-col items-center lg:items-start">
              <span className="text-white/80 font-manrope font-semibold text-sm uppercase tracking-widest block mb-2">Special Discount for</span>
              ...
              >
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" className="transition-transform duration-300 group-hover:scale-105">
            ...
            <div className="relative flex items-center justify-center w-[200px] h-[200px] sm:w-[240px] sm:h-[240px] flex-shrink-0">
              ...
              <div className="relative text-center z-10 select-none">
                <span className="font-manrope font-black text-6xl sm:text-7xl md:text-[85px] text-white leading-none tracking-tight">30%</span>
                <span className="block font-manrope font-bold text-2xl sm:text-3xl text-white -mt-1 tracking-widest">OFF</span>
              </div>
            </div>
          </div>
        </div>
