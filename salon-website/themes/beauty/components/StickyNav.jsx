...
export default function StickyNav() {
  ...
  return (
    <nav
      className={`w-full z-50 transition-all duration-300 border-b border-[#F5ECE7]
        ${
          isSticky
      ...
      <div className="max-w-[1360px] mx-auto px-4">
        ...
        <div className="flex items-center justify-between py-2 lg:hidden">
          ...
          <button
            ...
            className="p-2.5 rounded-full hover:bg-gray-100 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-[#c98f8f]"
