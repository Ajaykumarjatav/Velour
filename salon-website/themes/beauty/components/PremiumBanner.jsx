...
export default function PremiumBanner() {
  return (
    <section className="w-full bg-[#F5ECE7] py-16 lg:py-20">
        ...
        <div className="relative rounded-[32px] overflow-hidden bg-[#2a2a2a] min-h-[340px] md:min-h-[380px] flex items-center shadow-xl">
          ...
          <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between w-full h-full px-6 sm:px-10 md:px-16 lg:px-20 py-12 md:py-16 gap-10">
            ...
            <div className="max-w-[550px] text-center lg:text-left flex flex-col items-center lg:items-start">
              <span className="text-salmon font-manrope font-semibold text-sm uppercase tracking-widest mb-2 block">
                Book Now
              </span>
              <h3 className="font-manrope font-extrabold text-3xl sm:text-4xl lg:text-[50px] lg:leading-[55px] text-white mb-6 tracking-tight">
                Ready For Your Next
                <br className="hidden lg:block" /> Glow-Up?
              </h3>
            ...
            <a
              href="#services"
              className="bg-[#c98f8f] hover:bg-primary-dark rounded-2xl p-8 md:p-10 flex flex-col items-center justify-center text-center w-full max-w-[320px] shadow-lg hover:shadow-primary/30 transition-all duration-300 hover:-translate-y-1.5 group outline-none focus-visible:ring-2 focus-visible:ring-white"
            >
              {/* Calendar icon */}
              <svg
