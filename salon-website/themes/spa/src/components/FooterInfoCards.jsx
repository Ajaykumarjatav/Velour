            ...
            >
              ...
              <div className="flex flex-col gap-2.5">
                {card.details.map((detail, j) => {
                  if (detail.startsWith('+')) {
                    return (
                      <a
                        ...
                        className="font-inter font-light text-sm md:text-base text-text-muted hover:text-primary transition-colors duration-200 select-text"
                      >
                        {detail}
                      </a>
                    )
                  ...
                  return (
                    <span key={j} className="font-inter font-light text-sm md:text-base text-text-muted leading-relaxed">
                      {detail}
                    </span>
                  )
                })}
