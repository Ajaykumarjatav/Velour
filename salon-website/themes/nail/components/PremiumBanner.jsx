      ...
      <div className="max-w-[1360px] mx-auto px-4">
        <div className="relative rounded-[32px] overflow-hidden bg-[#2a2a2a] min-h-[340px] md:min-h-[380px] flex items-center shadow-xl">
          ...
          <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between w-full h-full px-6 sm:px-10 md:px-16 lg:px-20 py-12 md:py-16 gap-10">
            ...
            <a
              href="#services"
              className="bg-[#b5556e] hover:bg-primary-dark rounded-2xl p-8 md:p-10 flex flex-col items-center justify-center text-center w-full max-w-[320px] shadow-lg hover:shadow-primary/30 transition-all duration-300 hover:-translate-y-1.5 group outline-none focus-visible:ring-2 focus-visible:ring-white"
            >
              {/* Calendar icon */}
              <svg
