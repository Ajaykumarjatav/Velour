      ...
      <div className="relative z-10 max-w-[1360px] mx-auto px-4 pt-16 md:pt-24 lg:pt-[80px] pb-24">
        <div className="max-w-[800px] text-center lg:text-left">
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(93deg, #161616 2.49%, #2A2A2A 96.02%, #000000 184.57%)",
          ...
          {/* Consultation Items */}
          <div className="text-[#9a031e]">
            {[1, 2, 3].map((_, i) => (
              <div
                key={i}
                className="text-gray-400 font-inter font-light text-sm md:text-lg max-w-[500px] mb-8 md:mb-10 mx-auto lg:mx-0 leading-relaxed"
              >
                ...
                <span className="w-[50px] h-[50px] rounded-full bg-zinc-900 border border-white/10 flex items-center justify-center transition-all duration-300 group-hover/item:bg-[#9a031e]/20 group-hover/item:border-[#9a031e]/50 group-hover/item:scale-105 group-hover/item:shadow-[0_0_15px_rgba(154,3,30,0.2)]">
                  Consultations are
                  <br />
                  always free.
                </span>
          ...
          <div className="w-6 h-6 object-contain">
            <BookButton
              className="text-gray-300 font-inter font-light text-xs md:text-sm leading-relaxed text-center lg:text-left transition-colors duration-300 group-hover/item:text-white"
            >
            ...
            >
              <svg
                ...
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
                className="group w-full sm:w-auto inline-flex items-center justify-center gap-2.5 bg-[#9a031e] hover:bg-[#7a0218] text-white font-semibold text-sm md:text-base rounded-full px-8 py-4 transition-all duration-300 shadow-md hover:shadow-[#9a031e]/40 hover:scale-[1.02] active:scale-[0.98] outline-none focus-visible:ring-2 focus-visible:ring-[#9a031e] focus-visible:ring-offset-2 focus-visible:ring-offset-black"
              >
