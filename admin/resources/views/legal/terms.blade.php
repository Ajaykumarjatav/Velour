...
<h2>1. Acceptance</h2>
<p>By registering for or using EasyGrox Salon SaaS ("Service"), you agree to these Terms of Service ("Terms") and our Privacy Policy. If you are using the Service on behalf of a business, you represent that you have authority to bind that business.</p>

<h2>2. Description of Service</h2>
<p>EasyGrox provides cloud-based salon management software including appointment booking, point-of-sale, client management, staff management, marketing tools, and reporting. Features vary by subscription plan.</p>
...
<ul>
  ...
  <li>You must notify us immediately of any unauthorised access at <a href="mailto:security@easygrox.com">security@easygrox.com</a>.</li>
</ul>
...
<p>As a data processor under GDPR Article 28, EasyGrox agrees to:</p>
<ul>
...
<p>EasyGrox and its licensors retain all rights to the Service, its design, code, and brand. These Terms grant you a limited, non-exclusive, non-transferable licence to use the Service for your internal business purposes.</p>
<p>You retain ownership of all data you upload or create within the Service.</p>

<h2>8. Availability &amp; SLA</h2>
<p>We target 99.9% monthly uptime for the Growth plan and above. Scheduled maintenance windows will be announced 48 hours in advance. Actual uptime is published at <strong>status.easygrox.com</strong>. Downtime credits are available upon request where SLA is breached.</p>

<h2>9. Limitation of Liability</h2>
<p>To the maximum extent permitted by law, EasyGrox's total liability to you for any claim arising out of or relating to these Terms or the Service shall not exceed the greater of (a) £100 or (b) the fees you paid in the three months preceding the claim.</p>
<p>EasyGrox shall not be liable for indirect, incidental, special, consequential, or punitive damages, including loss of profits, data, or business opportunity.</p>
...
<h2>12. Contact</h2>
<p>Legal enquiries: <a href="mailto:legal@easygrox.com">legal@easygrox.com</a></p>
