...
@endphp
<section id="amenities" class="w-full bg-[#F5ECE7] py-20 lg:py-24">
    <div class="max-w-[1360px] mx-auto px-4">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 md:gap-6 mb-5 md:mb-6">
            @foreach($amenitiesRow1 as $item)
