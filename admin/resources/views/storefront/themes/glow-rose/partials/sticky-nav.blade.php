...
<nav
    ...
    class="sf-sticky-nav w-full z-50 transition-all duration-300 border-b border-gray-100"
    :class="isSticky ? 'fixed top-0 left-0 right-0 shadow-lg bg-white/95 backdrop-blur-md py-1' : 'relative bg-section-lightest py-3'"
>
    <div class="max-w-[1360px] mx-auto px-4">
        <div class="flex items-center justify-between py-2 lg:hidden">
            <span class="font-manrope font-bold text-lg text-black tracking-wide uppercase">Menu</span>
            <button
                @click="menuOpen = !menuOpen"
                class="p-2.5 rounded-full hover:bg-gray-100 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-primary-dark"
