@extends('emails.auth._layout', ['subject' => 'Your EasyGrox trial ends in 3 days'])
@section('body')
<p class="greeting">Your trial ends {{ $trialEndsAt->format('d M Y') }}</p>
<p class="text">Hi {{ $user->name }}, just a heads-up — your EasyGrox free trial ends in 3 days. To keep your full access, add a payment method before the trial expires.</p>
