...
- Name: admin-pages.spec.ts >> Super Admin pages (plan SA-*) >> SA-09a GET /admin/tenants/2/clients
- Location: tests\playwright\admin-pages.spec.ts:44:5

# Error details

```
Error: SA-09a admin/tenants/2/clients status
  ...
  - main [ref=e16]:
    - generic [ref=e17]:
      ...
      - generic [ref=e810]:
        ...
        - generic [ref=e812]: GET /admin/tenants/2/clients
      ...
      - generic [ref=e896]:
        ...
        - generic [ref=e899]:
          - generic [ref=e900]:
            ...
            - code [ref=e904]: App\Http\Controllers\Admin\Tenant\AdminTenantClientController@index
          - generic [ref=e905]:
            - generic [ref=e906] [cursor=pointer]: route name
            - code [ref=e909]: admin.tenants.clients.index
          - generic [ref=e910]:
        ...
        - generic [ref=e922]:
          - generic [ref=e923]:
            - generic [ref=e924]:
              - text: mysql
              - generic [ref=e925]: (4.75 ms)
            - code [ref=e928]: "select * from `users` where `id` = 1 and `users`.`deleted_at` is null limit 1"
          - generic [ref=e929]:
            - generic [ref=e930]:
              - text: mysql
              - generic [ref=e931]: (0.81 ms)
            - code [ref=e934]: "select * from `salons` where `salons`.`id` = 2 limit 1"
          - generic [ref=e935]:
            - generic [ref=e936]:
              - text: mysql
              - generic [ref=e937]: (2.42 ms)
            - code [ref=e940]: "insert into `audit_logs` (`user_id`, `user_email`, `user_name`, `salon_id`, `event`, `event_category`, `severity`, `description`, `subject_type`, `subject_id`, `metadata`, `ip_address`, `user_agent`, `session_id`, `request_id`, `http_method`, `url`, `occurred_at`) values (1, 'admin@velour.app', 'Velour Admin', 2, 'admin.tenant.view', 'admin', 'warning', 'Admin viewed clients.index list for salon 'ak salon'', 'App\\Models\\Salon', 2, '{\"module\":\"clients.index\",\"salon_id\":2}', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.7922.34 Safari/537.36', 'EVylLVZnikIxF2MdWsshwm23DmppHzyCjf8oYXN1', NULL, 'GET', 'http://localhost/admin/tenants/2/clients', '2026-08-09 12:35:41')"
          - generic [ref=e941]:
            - generic [ref=e942]:
              - text: mysql
              - generic [ref=e943]: (1.75 ms)
            - code [ref=e946]: "select count(*) as aggregate from `clients` where `salon_id` = 2"
          - generic [ref=e947]:
            - generic [ref=e948]:
              - text: mysql
              - generic [ref=e949]: (3.6 ms)
            - code [ref=e952]: "select * from `clients` where `salon_id` = 2 order by `id` desc limit 25 offset 0"
          - generic [ref=e953]:
            - generic [ref=e954]:
              - text: mysql
              - generic [ref=e955]: (0.77 ms)
          ...
          - generic [ref=e1475]:
            - generic [ref=e1476]:
              - text: mysql
              - generic [ref=e1477]: (0.61 ms)
            - code [ref=e1480]: "select `salon_id` from `staff` where `user_id` = 1 and `deleted_at` is null limit 1"
          - generic [ref=e1481]:
            - generic [ref=e1482]:
              - text: mysql
              - generic [ref=e1483]: (1.2 ms)
            - code [ref=e1486]: "select * from `users` where `users`.`id` = 5 and `users`.`deleted_at` is null limit 1"
          - generic [ref=e1487]:
            - generic [ref=e1488]:
              - text: mysql
              - generic [ref=e1489]: (0.61 ms)
          ...
          - generic [ref=e1499]:
            - generic [ref=e1500]:
              - text: mysql
              - generic [ref=e1501]: (0.95 ms)
            - code [ref=e1504]: "select count(*) as aggregate from `support_tickets` where `status` in ('open', 'in_progress') and `assigned_to` is null"
          - generic [ref=e1505]:
            - generic [ref=e1506]:
              - text: mysql
              - generic [ref=e1507]: (2.55 ms)
