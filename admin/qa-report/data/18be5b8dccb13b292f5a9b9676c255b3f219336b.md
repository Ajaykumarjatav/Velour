...
- Name: admin-pages.spec.ts >> Super Admin pages (plan SA-*) >> SA-09k GET /admin/tenants/2/attendance
- Location: tests\playwright\admin-pages.spec.ts:44:5

# Error details

```
Error: SA-09k admin/tenants/2/attendance status
  ...
  - main [ref=e16]:
    - generic [ref=e17]:
      ...
      - generic [ref=e810]:
        ...
        - generic [ref=e812]: GET /admin/tenants/2/attendance
      ...
      - generic [ref=e896]:
        ...
        - generic [ref=e899]:
          - generic [ref=e900]:
            ...
            - code [ref=e904]: App\Http\Controllers\Admin\Tenant\AdminTenantAttendanceController@index
          - generic [ref=e905]:
            - generic [ref=e906] [cursor=pointer]: route name
            - code [ref=e909]: admin.tenants.attendance.index
          - generic [ref=e910]:
        ...
        - generic [ref=e922]:
          - generic [ref=e923]:
            - generic [ref=e924]:
              - text: mysql
              - generic [ref=e925]: (3.71 ms)
            - code [ref=e928]: "select * from `users` where `id` = 1 and `users`.`deleted_at` is null limit 1"
          - generic [ref=e929]:
            - generic [ref=e930]:
              - text: mysql
              - generic [ref=e931]: (0.82 ms)
            - code [ref=e934]: "select * from `salons` where `salons`.`id` = 2 limit 1"
          - generic [ref=e935]:
            - generic [ref=e936]:
              - text: mysql
              - generic [ref=e937]: (1.73 ms)
            - code [ref=e940]: "insert into `audit_logs` (`user_id`, `user_email`, `user_name`, `salon_id`, `event`, `event_category`, `severity`, `description`, `subject_type`, `subject_id`, `metadata`, `ip_address`, `user_agent`, `session_id`, `request_id`, `http_method`, `url`, `occurred_at`) values (1, 'admin@velour.app', 'Velour Admin', 2, 'admin.tenant.view', 'admin', 'warning', 'Admin viewed attendance.index list for salon 'ak salon'', 'App\\Models\\Salon', 2, '{\"module\":\"attendance.index\",\"salon_id\":2}', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.7922.34 Safari/537.36', 'EVylLVZnikIxF2MdWsshwm23DmppHzyCjf8oYXN1', NULL, 'GET', 'http://localhost/admin/tenants/2/attendance', '2026-08-09 12:37:52')"
          - generic [ref=e941]:
            - generic [ref=e942]:
              - text: mysql
              - generic [ref=e943]: (0.88 ms)
            - code [ref=e946]: "select count(*) as aggregate from `staff_attendance_records` where `salon_id` = 2"
          - generic [ref=e947]:
            - generic [ref=e948]:
              - text: mysql
              - generic [ref=e949]: (0.98 ms)
            - code [ref=e952]: "select * from `staff_attendance_records` where `salon_id` = 2 order by `attendance_date` desc limit 25 offset 0"
          - generic [ref=e953]:
            - generic [ref=e954]:
              - text: mysql
              - generic [ref=e955]: (0.61 ms)
            - code [ref=e958]: "select `id`, `first_name`, `last_name` from `staff` where `staff`.`id` in (7, 8, 17, 21, 22, 24) and `staff`.`deleted_at` is null"
          - generic [ref=e959]:
            - generic [ref=e960]:
              - text: mysql
              - generic [ref=e961]: (0.61 ms)
          ...
          - generic [ref=e1037]:
            - generic [ref=e1038]:
              - text: mysql
              - generic [ref=e1039]: (0.21 ms)
            - code [ref=e1042]: "select `salon_id` from `staff` where `user_id` = 1 and `deleted_at` is null limit 1"
          - generic [ref=e1043]:
            - generic [ref=e1044]:
              - text: mysql
              - generic [ref=e1045]: (0.42 ms)
            - code [ref=e1048]: "select exists(select * from `salons` where `salons`.`owner_id` = 1 and `salons`.`owner_id` is not null and `salons`.`deleted_at` is null) as `exists`"
          - generic [ref=e1049]:
            - generic [ref=e1050]:
              - text: mysql
              - generic [ref=e1051]: (0.2 ms)
            - code [ref=e1054]: "select `salon_id` from `staff` where `user_id` = 1 and `deleted_at` is null limit 1"
          - generic [ref=e1055]:
            - generic [ref=e1056]:
              - text: mysql
              - generic [ref=e1057]: (0.43 ms)
            - code [ref=e1060]: "select exists(select * from `salons` where `salons`.`owner_id` = 1 and `salons`.`owner_id` is not null and `salons`.`deleted_at` is null) as `exists`"
          - generic [ref=e1061]:
            - generic [ref=e1062]:
              - text: mysql
              - generic [ref=e1063]: (0.49 ms)
            - code [ref=e1066]: "select `salon_id` from `staff` where `user_id` = 1 and `deleted_at` is null limit 1"
          - generic [ref=e1067]:
            - generic [ref=e1068]:
              - text: mysql
              - generic [ref=e1069]: (0.36 ms)
            - code [ref=e1072]: "select exists(select * from `salons` where `salons`.`owner_id` = 1 and `salons`.`owner_id` is not null and `salons`.`deleted_at` is null) as `exists`"
          - generic [ref=e1073]:
            - generic [ref=e1074]:
              - text: mysql
              - generic [ref=e1075]: (0.57 ms)
            - code [ref=e1078]: "select `salon_id` from `staff` where `user_id` = 1 and `deleted_at` is null limit 1"
          - generic [ref=e1079]:
            - generic [ref=e1080]:
              - text: mysql
              - generic [ref=e1081]: (0.66 ms)
            - code [ref=e1084]: "select exists(select * from `salons` where `salons`.`owner_id` = 1 and `salons`.`owner_id` is not null and `salons`.`deleted_at` is null) as `exists`"
          - generic [ref=e1085]:
            - generic [ref=e1086]:
              - text: mysql
              - generic [ref=e1087]: (0.49 ms)
            - code [ref=e1090]: "select `salon_id` from `staff` where `user_id` = 1 and `deleted_at` is null limit 1"
          - generic [ref=e1091]:
            - generic [ref=e1092]:
              - text: mysql
              - generic [ref=e1093]: (0.65 ms)
            - code [ref=e1096]: "select exists(select * from `salons` where `salons`.`owner_id` = 1 and `salons`.`owner_id` is not null and `salons`.`deleted_at` is null) as `exists`"
          - generic [ref=e1097]:
            - generic [ref=e1098]:
              - text: mysql
              - generic [ref=e1099]: (0.46 ms)
            - code [ref=e1102]: "select `salon_id` from `staff` where `user_id` = 1 and `deleted_at` is null limit 1"
          - generic [ref=e1103]:
            - generic [ref=e1104]:
              - text: mysql
              - generic [ref=e1105]: (0.72 ms)
          ...
          - generic [ref=e1109]:
            - generic [ref=e1110]:
              - text: mysql
              - generic [ref=e1111]: (0.83 ms)
            - code [ref=e1114]: "select `salon_id` from `staff` where `user_id` = 1 and `deleted_at` is null limit 1"
          - generic [ref=e1115]:
            - generic [ref=e1116]:
              - text: mysql
              - generic [ref=e1117]: (0.39 ms)
            - code [ref=e1120]: "select exists(select * from `salons` where `salons`.`owner_id` = 1 and `salons`.`owner_id` is not null and `salons`.`deleted_at` is null) as `exists`"
          - generic [ref=e1121]:
            - generic [ref=e1122]:
              - text: mysql
              - generic [ref=e1123]: (0.46 ms)
            - code [ref=e1126]: "select `salon_id` from `staff` where `user_id` = 1 and `deleted_at` is null limit 1"
          - generic [ref=e1127]:
            - generic [ref=e1128]:
              - text: mysql
              - generic [ref=e1129]: (0.48 ms)
            - code [ref=e1132]: "select exists(select * from `salons` where `salons`.`owner_id` = 1 and `salons`.`owner_id` is not null and `salons`.`deleted_at` is null) as `exists`"
          - generic [ref=e1133]:
            - generic [ref=e1134]:
              - text: mysql
              - generic [ref=e1135]: (0.23 ms)
            - code [ref=e1138]: "select `salon_id` from `staff` where `user_id` = 1 and `deleted_at` is null limit 1"
          - generic [ref=e1139]:
            - generic [ref=e1140]:
              - text: mysql
              - generic [ref=e1141]: (0.61 ms)
            - code [ref=e1144]: "select exists(select * from `salons` where `salons`.`owner_id` = 1 and `salons`.`owner_id` is not null and `salons`.`deleted_at` is null) as `exists`"
          - generic [ref=e1145]:
            - generic [ref=e1146]:
              - text: mysql
              - generic [ref=e1147]: (0.45 ms)
            - code [ref=e1150]: "select `salon_id` from `staff` where `user_id` = 1 and `deleted_at` is null limit 1"
          - generic [ref=e1151]:
            - generic [ref=e1152]:
              - text: mysql
              - generic [ref=e1153]: (0.65 ms)
            - code [ref=e1156]: "select exists(select * from `salons` where `salons`.`owner_id` = 1 and `salons`.`owner_id` is not null and `salons`.`deleted_at` is null) as `exists`"
          - generic [ref=e1157]:
            - generic [ref=e1158]:
              - text: mysql
              - generic [ref=e1159]: (0.46 ms)
            - code [ref=e1162]: "select `salon_id` from `staff` where `user_id` = 1 and `deleted_at` is null limit 1"
          - generic [ref=e1163]:
            - generic [ref=e1164]:
              - text: mysql
              - generic [ref=e1165]: (0.49 ms)
            - code [ref=e1168]: "select exists(select * from `salons` where `salons`.`owner_id` = 1 and `salons`.`owner_id` is not null and `salons`.`deleted_at` is null) as `exists`"
          - generic [ref=e1169]:
            - generic [ref=e1170]:
              - text: mysql
              - generic [ref=e1171]: (0.46 ms)
            - code [ref=e1174]: "select `salon_id` from `staff` where `user_id` = 1 and `deleted_at` is null limit 1"
          - generic [ref=e1175]:
            - generic [ref=e1176]:
              - text: mysql
              - generic [ref=e1177]: (0.69 ms)
            - code [ref=e1180]: "select exists(select * from `salons` where `salons`.`owner_id` = 1 and `salons`.`owner_id` is not null and `salons`.`deleted_at` is null) as `exists`"
          - generic [ref=e1181]:
            - generic [ref=e1182]:
              - text: mysql
              - generic [ref=e1183]: (0.45 ms)
            - code [ref=e1186]: "select `salon_id` from `staff` where `user_id` = 1 and `deleted_at` is null limit 1"
          - generic [ref=e1187]:
            - generic [ref=e1188]:
              - text: mysql
              - generic [ref=e1189]: (0.33 ms)
            - code [ref=e1192]: "select exists(select * from `salons` where `salons`.`owner_id` = 1 and `salons`.`owner_id` is not null and `salons`.`deleted_at` is null) as `exists`"
          - generic [ref=e1193]:
            - generic [ref=e1194]:
              - text: mysql
              - generic [ref=e1195]: (0.53 ms)
            - code [ref=e1198]: "select `salon_id` from `staff` where `user_id` = 1 and `deleted_at` is null limit 1"
          - generic [ref=e1199]:
            - generic [ref=e1200]:
              - text: mysql
              - generic [ref=e1201]: (0.58 ms)
            - code [ref=e1204]: "select exists(select * from `salons` where `salons`.`owner_id` = 1 and `salons`.`owner_id` is not null and `salons`.`deleted_at` is null) as `exists`"
          - generic [ref=e1205]:
            - generic [ref=e1206]:
              - text: mysql
              - generic [ref=e1207]: (0.53 ms)
            - code [ref=e1210]: "select `salon_id` from `staff` where `user_id` = 1 and `deleted_at` is null limit 1"
          - generic [ref=e1211]:
            - generic [ref=e1212]:
              - text: mysql
              - generic [ref=e1213]: (0.64 ms)
            - code [ref=e1216]: "select exists(select * from `salons` where `salons`.`owner_id` = 1 and `salons`.`owner_id` is not null and `salons`.`deleted_at` is null) as `exists`"
          - generic [ref=e1217]:
            - generic [ref=e1218]:
              - text: mysql
              - generic [ref=e1219]: (0.54 ms)
            - code [ref=e1222]: "select `salon_id` from `staff` where `user_id` = 1 and `deleted_at` is null limit 1"
          - generic [ref=e1223]:
            - generic [ref=e1224]:
              - text: mysql
              - generic [ref=e1225]: (0.37 ms)
            - code [ref=e1228]: "select exists(select * from `salons` where `salons`.`owner_id` = 1 and `salons`.`owner_id` is not null and `salons`.`deleted_at` is null) as `exists`"
          - generic [ref=e1229]:
            - generic [ref=e1230]:
              - text: mysql
              - generic [ref=e1231]: (0.58 ms)
            - code [ref=e1234]: "select `salon_id` from `staff` where `user_id` = 1 and `deleted_at` is null limit 1"
          - generic [ref=e1235]:
            - generic [ref=e1236]:
              - text: mysql
              - generic [ref=e1237]: (0.81 ms)
            - code [ref=e1240]: "select exists(select * from `salons` where `salons`.`owner_id` = 1 and `salons`.`owner_id` is not null and `salons`.`deleted_at` is null) as `exists`"
          - generic [ref=e1241]:
            - generic [ref=e1242]:
              - text: mysql
              - generic [ref=e1243]: (0.47 ms)
            - code [ref=e1246]: "select `salon_id` from `staff` where `user_id` = 1 and `deleted_at` is null limit 1"
          - generic [ref=e1247]:
            - generic [ref=e1248]:
              - text: mysql
              - generic [ref=e1249]: (0.6 ms)
            - code [ref=e1252]: "select exists(select * from `salons` where `salons`.`owner_id` = 1 and `salons`.`owner_id` is not null and `salons`.`deleted_at` is null) as `exists`"
          - generic [ref=e1253]:
            - generic [ref=e1254]:
              - text: mysql
              - generic [ref=e1255]: (0.45 ms)
            - code [ref=e1258]: "select `salon_id` from `staff` where `user_id` = 1 and `deleted_at` is null limit 1"
          - generic [ref=e1259]:
            - generic [ref=e1260]:
              - text: mysql
              - generic [ref=e1261]: (0.63 ms)
            - code [ref=e1264]: "select exists(select * from `salons` where `salons`.`owner_id` = 1 and `salons`.`owner_id` is not null and `salons`.`deleted_at` is null) as `exists`"
          - generic [ref=e1265]:
            - generic [ref=e1266]:
              - text: mysql
              - generic [ref=e1267]: (0.52 ms)
            - code [ref=e1270]: "select `salon_id` from `staff` where `user_id` = 1 and `deleted_at` is null limit 1"
          - generic [ref=e1271]:
            - generic [ref=e1272]:
              - text: mysql
              - generic [ref=e1273]: (0.33 ms)
            - code [ref=e1276]: "select exists(select * from `salons` where `salons`.`owner_id` = 1 and `salons`.`owner_id` is not null and `salons`.`deleted_at` is null) as `exists`"
          - generic [ref=e1277]:
            - generic [ref=e1278]:
              - text: mysql
              - generic [ref=e1279]: (0.6 ms)
            - code [ref=e1282]: "select `salon_id` from `staff` where `user_id` = 1 and `deleted_at` is null limit 1"
          - generic [ref=e1283]:
            - generic [ref=e1284]:
              - text: mysql
              - generic [ref=e1285]: (0.34 ms)
            - code [ref=e1288]: "select exists(select * from `salons` where `salons`.`owner_id` = 1 and `salons`.`owner_id` is not null and `salons`.`deleted_at` is null) as `exists`"
          - generic [ref=e1289]:
            - generic [ref=e1290]:
              - text: mysql
              - generic [ref=e1291]: (0.59 ms)
            - code [ref=e1294]: "select `salon_id` from `staff` where `user_id` = 1 and `deleted_at` is null limit 1"
          - generic [ref=e1295]:
            - generic [ref=e1296]:
              - text: mysql
              - generic [ref=e1297]: (0.67 ms)
            - code [ref=e1300]: "select exists(select * from `salons` where `salons`.`owner_id` = 1 and `salons`.`owner_id` is not null and `salons`.`deleted_at` is null) as `exists`"
          - generic [ref=e1301]:
            - generic [ref=e1302]:
              - text: mysql
              - generic [ref=e1303]: (0.5 ms)
            - code [ref=e1306]: "select `salon_id` from `staff` where `user_id` = 1 and `deleted_at` is null limit 1"
          - generic [ref=e1307]:
            - generic [ref=e1308]:
              - text: mysql
              - generic [ref=e1309]: (0.78 ms)
            - code [ref=e1312]: "select exists(select * from `salons` where `salons`.`owner_id` = 1 and `salons`.`owner_id` is not null and `salons`.`deleted_at` is null) as `exists`"
          - generic [ref=e1313]:
            - generic [ref=e1314]:
              - text: mysql
              - generic [ref=e1315]: (0.47 ms)
            - code [ref=e1318]: "select `salon_id` from `staff` where `user_id` = 1 and `deleted_at` is null limit 1"
          - generic [ref=e1319]:
            - generic [ref=e1320]:
              - text: mysql
              - generic [ref=e1321]: (0.48 ms)
            - code [ref=e1324]: "select exists(select * from `salons` where `salons`.`owner_id` = 1 and `salons`.`owner_id` is not null and `salons`.`deleted_at` is null) as `exists`"
          - generic [ref=e1325]:
            - generic [ref=e1326]:
              - text: mysql
              - generic [ref=e1327]: (0.47 ms)
            - code [ref=e1330]: "select `salon_id` from `staff` where `user_id` = 1 and `deleted_at` is null limit 1"
          - generic [ref=e1331]:
            - generic [ref=e1332]:
              - text: mysql
              - generic [ref=e1333]: (0.36 ms)
            - code [ref=e1336]: "select exists(select * from `salons` where `salons`.`owner_id` = 1 and `salons`.`owner_id` is not null and `salons`.`deleted_at` is null) as `exists`"
          - generic [ref=e1337]:
            - generic [ref=e1338]:
              - text: mysql
              - generic [ref=e1339]: (0.29 ms)
            - code [ref=e1342]: "select `salon_id` from `staff` where `user_id` = 1 and `deleted_at` is null limit 1"
          - generic [ref=e1343]:
            - generic [ref=e1344]:
              - text: mysql
              - generic [ref=e1345]: (0.68 ms)
            - code [ref=e1348]: "select exists(select * from `salons` where `salons`.`owner_id` = 1 and `salons`.`owner_id` is not null and `salons`.`deleted_at` is null) as `exists`"
          - generic [ref=e1349]:
            - generic [ref=e1350]:
              - text: mysql
              - generic [ref=e1351]: (0.31 ms)
            - code [ref=e1354]: "select `salon_id` from `staff` where `user_id` = 1 and `deleted_at` is null limit 1"
          - generic [ref=e1355]:
            - generic [ref=e1356]:
              - text: mysql
              - generic [ref=e1357]: (0.69 ms)
            - code [ref=e1360]: "select exists(select * from `salons` where `salons`.`owner_id` = 1 and `salons`.`owner_id` is not null and `salons`.`deleted_at` is null) as `exists`"
          - generic [ref=e1361]:
            - generic [ref=e1362]:
              - text: mysql
              - generic [ref=e1363]: (0.52 ms)
            - code [ref=e1366]: "select `salon_id` from `staff` where `user_id` = 1 and `deleted_at` is null limit 1"
          - generic [ref=e1367]:
            - generic [ref=e1368]:
              - text: mysql
              - generic [ref=e1369]: (0.47 ms)
            - code [ref=e1372]: "select exists(select * from `salons` where `salons`.`owner_id` = 1 and `salons`.`owner_id` is not null and `salons`.`deleted_at` is null) as `exists`"
          - generic [ref=e1373]:
            - generic [ref=e1374]:
              - text: mysql
              - generic [ref=e1375]: (0.99 ms)
            - code [ref=e1378]: "select `salon_id` from `staff` where `user_id` = 1 and `deleted_at` is null limit 1"
          - generic [ref=e1379]:
            - generic [ref=e1380]:
              - text: mysql
              - generic [ref=e1381]: (1.43 ms)
            - code [ref=e1384]: "select exists(select * from `salons` where `salons`.`owner_id` = 1 and `salons`.`owner_id` is not null and `salons`.`deleted_at` is null) as `exists`"
          - generic [ref=e1385]:
            - generic [ref=e1386]:
              - text: mysql
              - generic [ref=e1387]: (0.46 ms)
            - code [ref=e1390]: "select `salon_id` from `staff` where `user_id` = 1 and `deleted_at` is null limit 1"
          - generic [ref=e1391]:
            - generic [ref=e1392]:
              - text: mysql
              - generic [ref=e1393]: (1.79 ms)
            - code [ref=e1396]: "select exists(select * from `salons` where `salons`.`owner_id` = 1 and `salons`.`owner_id` is not null and `salons`.`deleted_at` is null) as `exists`"
          - generic [ref=e1397]:
            - generic [ref=e1398]:
              - text: mysql
              - generic [ref=e1399]: (0.49 ms)
            - code [ref=e1402]: "select `salon_id` from `staff` where `user_id` = 1 and `deleted_at` is null limit 1"
          - generic [ref=e1403]:
            - generic [ref=e1404]:
              - text: mysql
              - generic [ref=e1405]: (0.59 ms)
            - code [ref=e1408]: "select exists(select * from `salons` where `salons`.`owner_id` = 1 and `salons`.`owner_id` is not null and `salons`.`deleted_at` is null) as `exists`"
          - generic [ref=e1409]:
            - generic [ref=e1410]:
              - text: mysql
              - generic [ref=e1411]: (0.37 ms)
            - code [ref=e1414]: "select `salon_id` from `staff` where `user_id` = 1 and `deleted_at` is null limit 1"
          - generic [ref=e1415]:
            - generic [ref=e1416]:
              - text: mysql
              - generic [ref=e1417]: (0.56 ms)
            - code [ref=e1420]: "select exists(select * from `salons` where `salons`.`owner_id` = 1 and `salons`.`owner_id` is not null and `salons`.`deleted_at` is null) as `exists`"
          - generic [ref=e1421]:
            - generic [ref=e1422]:
              - text: mysql
              - generic [ref=e1423]: (0.33 ms)
            - code [ref=e1426]: "select `salon_id` from `staff` where `user_id` = 1 and `deleted_at` is null limit 1"
          - generic [ref=e1427]:
            - generic [ref=e1428]:
              - text: mysql
              - generic [ref=e1429]: (0.6 ms)
            - code [ref=e1432]: "select exists(select * from `salons` where `salons`.`owner_id` = 1 and `salons`.`owner_id` is not null and `salons`.`deleted_at` is null) as `exists`"
          - generic [ref=e1433]:
            - generic [ref=e1434]:
              - text: mysql
              - generic [ref=e1435]: (0.29 ms)
            - code [ref=e1438]: "select `salon_id` from `staff` where `user_id` = 1 and `deleted_at` is null limit 1"
          - generic [ref=e1439]:
            - generic [ref=e1440]:
              - text: mysql
              - generic [ref=e1441]: (1.46 ms)
            - code [ref=e1444]: "select exists(select * from `salons` where `salons`.`owner_id` = 1 and `salons`.`owner_id` is not null and `salons`.`deleted_at` is null) as `exists`"
          - generic [ref=e1445]:
            - generic [ref=e1446]:
              - text: mysql
              - generic [ref=e1447]: (2.2 ms)
            - code [ref=e1450]: "select `salon_id` from `staff` where `user_id` = 1 and `deleted_at` is null limit 1"
          - generic [ref=e1451]:
            - generic [ref=e1452]:
              - text: mysql
              - generic [ref=e1453]: (0.98 ms)
            - code [ref=e1456]: "select exists(select * from `salons` where `salons`.`owner_id` = 1 and `salons`.`owner_id` is not null and `salons`.`deleted_at` is null) as `exists`"
          - generic [ref=e1457]:
            - generic [ref=e1458]:
              - text: mysql
              - generic [ref=e1459]: (0.96 ms)
            - code [ref=e1462]: "select `salon_id` from `staff` where `user_id` = 1 and `deleted_at` is null limit 1"
          - generic [ref=e1463]:
            - generic [ref=e1464]:
              - text: mysql
              - generic [ref=e1465]: (0.78 ms)
            - code [ref=e1468]: "select exists(select * from `salons` where `salons`.`owner_id` = 1 and `salons`.`owner_id` is not null and `salons`.`deleted_at` is null) as `exists`"
          - generic [ref=e1469]:
            - generic [ref=e1470]:
              - text: mysql
              - generic [ref=e1471]: (0.37 ms)
            - code [ref=e1474]: "select `salon_id` from `staff` where `user_id` = 1 and `deleted_at` is null limit 1"
          - generic [ref=e1475]:
            - generic [ref=e1476]:
              - text: mysql
              - generic [ref=e1477]: (0.67 ms)
            - code [ref=e1480]: "select exists(select * from `salons` where `salons`.`owner_id` = 1 and `salons`.`owner_id` is not null and `salons`.`deleted_at` is null) as `exists`"
          - generic [ref=e1481]:
            - generic [ref=e1482]:
              - text: mysql
              - generic [ref=e1483]: (0.55 ms)
            - code [ref=e1486]: "select `salon_id` from `staff` where `user_id` = 1 and `deleted_at` is null limit 1"
          - generic [ref=e1487]:
            - generic [ref=e1488]:
              - text: mysql
              - generic [ref=e1489]: (0.47 ms)
            - code [ref=e1492]: "select exists(select * from `salons` where `salons`.`owner_id` = 1 and `salons`.`owner_id` is not null and `salons`.`deleted_at` is null) as `exists`"
          - generic [ref=e1493]:
            - generic [ref=e1494]:
              - text: mysql
              - generic [ref=e1495]: (0.31 ms)
            - code [ref=e1498]: "select `salon_id` from `staff` where `user_id` = 1 and `deleted_at` is null limit 1"
          - generic [ref=e1499]:
            - generic [ref=e1500]:
              - text: mysql
              - generic [ref=e1501]: (0.49 ms)
            - code [ref=e1504]: "select exists(select * from `salons` where `salons`.`owner_id` = 1 and `salons`.`owner_id` is not null and `salons`.`deleted_at` is null) as `exists`"
          - generic [ref=e1505]:
            - generic [ref=e1506]:
              - text: mysql
              - generic [ref=e1507]: (0.56 ms)
            - code [ref=e1510]: "select `salon_id` from `staff` where `user_id` = 1 and `deleted_at` is null limit 1"
          - generic [ref=e1511]:
            - generic [ref=e1512]:
              - text: mysql
              - generic [ref=e1513]: (1 ms)
            - code [ref=e1516]: "select exists(select * from `salons` where `salons`.`owner_id` = 1 and `salons`.`owner_id` is not null and `salons`.`deleted_at` is null) as `exists`"
          - generic [ref=e1517]:
            - generic [ref=e1518]:
              - text: mysql
              - generic [ref=e1519]: (0.65 ms)
            - code [ref=e1522]: "select `salon_id` from `staff` where `user_id` = 1 and `deleted_at` is null limit 1"
```
