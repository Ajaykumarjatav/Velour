...
- Name: admin-pages.spec.ts >> Super Admin pages (plan SA-*) >> SA-09l GET /admin/tenants/2/settings
- Location: tests\playwright\admin-pages.spec.ts:44:5

# Error details

```
Error: SA-09l admin/tenants/2/settings status
      ...
      - generic [ref=e29]:
        - generic [ref=e31]:
          ...
          - generic [ref=e41]:
            ...
            - button "C:\\xampp\\htdocs\\vellor\\admin\\resources\\views\\admin\\tenants\\settings\\show.blade.php :41 require" [ref=e210] [cursor=pointer]:
              - generic [ref=e212]:
                - generic [ref=e214]:
                  - generic [ref=e215]: C:\xampp\htdocs\vellor\admin\resources\views\admin\tenants\settings\show.blade.php
                  - generic [ref=e216]: :41
      ...
      - generic [ref=e896]:
        ...
        - generic [ref=e899]:
          - generic [ref=e900]:
            ...
            - code [ref=e904]: App\Http\Controllers\Admin\Tenant\AdminTenantSettingsController@show
          - generic [ref=e905]:
            - generic [ref=e906] [cursor=pointer]: route name
            - code [ref=e909]: admin.tenants.settings
          - generic [ref=e910]:
        ...
        - generic [ref=e922]:
          - generic [ref=e923]:
            - generic [ref=e924]:
              - text: mysql
              - generic [ref=e925]: (3.13 ms)
            - code [ref=e928]: "select * from `users` where `id` = 1 and `users`.`deleted_at` is null limit 1"
          - generic [ref=e929]:
            - generic [ref=e930]:
              - text: mysql
              - generic [ref=e931]: (0.64 ms)
            - code [ref=e934]: "select * from `salons` where `salons`.`id` = 2 limit 1"
          - generic [ref=e935]:
            - generic [ref=e936]:
              - text: mysql
              - generic [ref=e937]: (1.62 ms)
            - code [ref=e940]: "select * from `salon_settings` where `salon_settings`.`salon_id` in (2)"
          - generic [ref=e941]:
            - generic [ref=e942]:
              - text: mysql
              - generic [ref=e943]: (1.55 ms)
            - code [ref=e946]: "insert into `audit_logs` (`user_id`, `user_email`, `user_name`, `salon_id`, `event`, `event_category`, `severity`, `description`, `subject_type`, `subject_id`, `metadata`, `ip_address`, `user_agent`, `session_id`, `request_id`, `http_method`, `url`, `occurred_at`) values (1, 'admin@velour.app', 'Velour Admin', 2, 'admin.tenant.view', 'admin', 'warning', 'Admin viewed settings list for salon 'ak salon'', 'App\\Models\\Salon', 2, '{\"module\":\"settings\",\"salon_id\":2}', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.7922.34 Safari/537.36', 'EVylLVZnikIxF2MdWsshwm23DmppHzyCjf8oYXN1', NULL, 'GET', 'http://localhost/admin/tenants/2/settings', '2026-08-09 12:38:02')"
          - generic [ref=e947]:
            - generic [ref=e948]:
              - text: mysql
              - generic [ref=e949]: (0.57 ms)
          ...
          - generic [ref=e1001]:
            - generic [ref=e1002]:
              - text: mysql
              - generic [ref=e1003]: (0.45 ms)
            - code [ref=e1006]: "select `salon_id` from `staff` where `user_id` = 1 and `deleted_at` is null limit 1"
          - generic [ref=e1007]:
            - generic [ref=e1008]:
              - text: mysql
              - generic [ref=e1009]: (1.07 ms)
            - code [ref=e1012]: "select * from `users` where `users`.`id` = 5 and `users`.`deleted_at` is null limit 1"
          - generic [ref=e1013]:
            - generic [ref=e1014]:
              - text: mysql
              - generic [ref=e1015]: (0.64 ms)
          ...
          - generic [ref=e1019]:
            - generic [ref=e1020]:
              - text: mysql
              - generic [ref=e1021]: (0.46 ms)
            - code [ref=e1024]: "select `salon_id` from `staff` where `user_id` = 1 and `deleted_at` is null limit 1"
          - generic [ref=e1025]:
            - generic [ref=e1026]:
              - text: mysql
              - generic [ref=e1027]: (0.76 ms)
            - code [ref=e1030]: "select count(*) as aggregate from `support_tickets` where `status` in ('open', 'in_progress') and `assigned_to` is null"
          - generic [ref=e1031]:
            - generic [ref=e1032]:
              - text: mysql
