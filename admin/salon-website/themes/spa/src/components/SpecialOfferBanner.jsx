...
export default function SpecialOfferBanner() {
  return (
    <section className="w-full bg-[#F8F8F8] py-16 lg:py-20 overflow-hidden">
      <div className="max-w-[1360px] mx-auto px-4">
        <div className="relative rounded-[32px] overflow-hidden bg-deep-[#7f390B] min-h-[360px] md:min-h-[400px] flex items-center shadow-xl">
