    ...
    <div class="max-w-[1360px] mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <div class="flex flex-col sm:flex-row items-center gap-4 lg:gap-10">
            <div class="flex flex-col md:flex-row items-center gap-2 md:gap-3 text-center md:text-right">
                <span class="text-[#9a031e] font-inter font-semibold text-xs md:text-sm uppercase tracking-widest">Timings</span>
                <div class="sf-hours flex items-center gap-2 md:gap-2.5 flex-wrap justify-center font-inter">
                    <span class="text-gray-300 font-light text-[11px] md:text-sm whitespace-nowrap">{{ $weekdayLine }}</span>
                    <span class="hidden md:block w-px h-4 bg-white/10"></span>
                    <span class="text-gray-300 font-light text-[11px] md:text-sm whitespace-nowrap">{{ $weekendLine }}</span>
                </div>
            </div>
            ...
            <a
                ...
                class="group flex items-center gap-2 text-white hover:text-[#9a031e] transition-colors duration-300 rounded-md px-2.5 py-1.5 bg-white/5 hover:bg-white/10 border border-white/10"
            >
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="currentColor" class="transition-transform duration-300 group-hover:scale-110">
