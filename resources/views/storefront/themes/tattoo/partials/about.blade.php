...
>
    <div class="relative w-full bg-black py-20 overflow-hidden">
        ...
        <div class="absolute -left-0 top-0 w-[380px] h-[680px] pointer-events-none opacity-30 lg:opacity-60 transition-opacity">
            <img
        ...
        <div class="absolute -right-0 top-0 w-[380px] h-[680px] pointer-events-none opacity-30 lg:opacity-60 transition-opacity">
            <img
