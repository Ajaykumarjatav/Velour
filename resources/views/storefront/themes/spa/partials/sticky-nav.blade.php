...
<nav
    ...
    :class="isSticky
        ? 'fixed top-0 left-0 right-0 shadow-lg bg-[#F8F8F8]/95 backdrop-blur-md py-1'
        : 'relative bg-section-lightest py-3'"
    class="sf-sticky-nav w-full z-50 transition-all duration-300 border-b border-[#F8F8F8]"
>
    <div class="max-w-[1360px] mx-auto px-4">
        <div class="flex items-center justify-between py-2 lg:hidden">
            ...
            <button
                ...
                class="p-2.5 rounded-full hover:bg-gray-100 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-[#b5556e]"
                aria-label="Toggle menu"
                :aria-expanded="menuOpen"
            >
                <svg x-show="!menuOpen" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" class="text-black">
                    <line x1="3" y1="6" x2="21" y2="6" stroke-linecap="round" />
                    <line x1="3" y1="12" x2="21" y2="12" stroke-linecap="round" />
                    <line x1="3" y1="18" x2="21" y2="18" stroke-linecap="round" />
                </svg>
                <svg x-show="menuOpen" x-cloak xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" class="text-black">
        ...
        >
            <div class="flex flex-col lg:flex-row items-center w-full lg:justify-center gap-1.5 lg:gap-8">
                ...
                >
                    ...
                    <span
                        :class="active === '{{ $link['label'] }}' ? 'w-full opacity-100' : 'w-0 opacity-0'"
