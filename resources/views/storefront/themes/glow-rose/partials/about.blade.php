...
<section id="about" class="w-full bg-white relative overflow-hidden">
    <div class="relative w-full bg-section-light py-20 overflow-hidden">
        <div class="max-w-[1360px] mx-auto px-4 relative z-25">
            <div class="w-full lg:w-[55%] relative z-20 mx-auto text-center lg:text-left">
                ...
                <h2 class="font-manrope font-extrabold text-4xl md:text-5xl lg:text-[60px] lg:leading-[69px] text-black mb-6 tracking-tight">
                    Where <span class="text-deep-maroon font-pacifico font-normal lowercase tracking-normal">artistry</span> meets
                    <br />
                    the art of living.
                </h2>
                ...
                <div class="flex items-center justify-center lg:justify-start gap-8 md:gap-14">
                    ...
                    <div class="w-px h-[90px] md:h-[110px] bg-gray-200"></div>
        ...
        <div class="absolute -left-24 top-10 w-[380px] h-[680px] pointer-events-none opacity-30 lg:opacity-100 transition-opacity">
            <img
        ...
        <div class="absolute -right-24 top-10 w-[380px] h-[680px] pointer-events-none opacity-30 lg:opacity-100 transition-opacity">
            <img
