@php
    ...
    if (!$salon) return;
    $heroImage = $salon['cover_image_url'] ?? $asset('26254 1.png');
    ...
    $whatsappUrl = $salon['whatsapp_url'] ?? '';
@endphp
