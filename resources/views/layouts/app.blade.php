    ...
    <div class="app-shell-main flex-1 flex flex-col min-h-screen min-w-0">
        ...
        <header class="sticky top-0 z-50 min-h-14 px-4 sm:px-6 flex flex-wrap items-center justify-between gap-2 sm:gap-3
            ...
            <div class="flex items-center gap-1 sm:gap-2 shrink-0">
                ...
                @endif
                {{-- EasyGrox support — one tap mail / call / WhatsApp --}}
                @php
                    $supportMailHref = \App\Support\SupportContact::emailMailtoHref();
                    $supportTelHref  = \App\Support\SupportContact::phoneTelHref();
                    $supportWaHref   = \App\Support\SupportContact::phoneWhatsAppHref();
                    $supportEmail    = \App\Support\SupportContact::emailDisplay();
                    $supportPhone    = \App\Support\SupportContact::phoneDisplay();
                @endphp
                <div class="flex items-center gap-0.5 sm:gap-1 border-r border-gray-200 dark:border-gray-700 pr-1 sm:pr-2 mr-0.5 sm:mr-1"
                     title="EasyGrox support">
                    <a href="{{ $supportMailHref }}"
                       class="p-2 rounded-lg text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 hover:text-sky-600 dark:hover:text-sky-400 transition-colors"
                       title="Email support — {{ $supportEmail }}"
                       aria-label="Email support {{ $supportEmail }}">
                    ...
                    <a href="{{ $supportTelHref }}"
                       class="p-2 rounded-lg text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors"
                    ...
                    <a href="{{ $supportWaHref }}"
                       target="_blank"
                       rel="noopener noreferrer"
                       class="p-2 rounded-lg text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 hover:text-emerald-500 dark:hover:text-emerald-400 transition-colors"
                       title="WhatsApp support — {{ $supportPhone }}"
