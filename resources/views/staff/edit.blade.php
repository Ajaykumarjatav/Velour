        ...
        <form action="{{ $action }}" method="POST" class="space-y-5">
            ...
            <div class="grid grid-cols-2 gap-4">
                <div class="col-span-2">
                    ...
                    <input type="text" name="name" value="{{ old('name', $staff->name ?? '') }}" required class="form-input">
                </div>
                <div>
                ...
                <div>
                    ...
                    <input type="tel" name="phone" value="{{ old('phone', $staff->phone ?? '') }}" class="form-input">
                </div>
                <div>
                ...
                <div>
                    ...
                    <input type="number" name="commission_rate" min="0" max="100" step="0.1" value="{{ old('commission_rate', $staff->commission_rate ?? 0) }}" class="form-input">
                </div>
                <div>
                ...
                <div class="col-span-2">
                    ...
                    <textarea name="bio" rows="3" class="form-textarea">{{ old('bio', $staff->bio ?? '') }}</textarea>
                </div>
            </div>
