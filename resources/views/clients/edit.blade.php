        ...
        <form action="{{ route('clients.update', $client->id) }}" method="POST" class="space-y-5">
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="first_name" value="{{ old('first_name', $client->first_name) }}" required class="form-input">
                </div>
                <div>
                    <label class="form-label">Last name <span class="text-red-500">*</span></label>
                    <input type="text" name="last_name" value="{{ old('last_name', $client->last_name) }}" required class="form-input">
                </div>
            </div>
            <div class="grid grid-cols-2 gap-4">
                <div>
            ...
            <div>
                ...
                <textarea name="notes" rows="3" class="form-textarea">{{ old('notes', $client->notes) }}</textarea>
            </div>
            <div>
