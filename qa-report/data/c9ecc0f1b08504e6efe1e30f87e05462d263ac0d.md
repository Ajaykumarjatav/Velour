...
- Name: admin-pages.spec.ts >> Super Admin pages (plan SA-*) >> SA-09m GET /admin/tenants/2/audit
- Location: tests\playwright\admin-pages.spec.ts:44:5

# Error details

```
Error: SA-09m admin/tenants/2/audit status
      ...
      - generic [ref=e29]:
        - generic [ref=e31]:
          ...
          - generic [ref=e41]:
            ...
            - button "C:\\xampp\\htdocs\\vellor\\admin\\resources\\views\\admin\\tenants\\audit\\index.blade.php :25 require" [ref=e210] [cursor=pointer]:
              - generic [ref=e212]:
                - generic [ref=e214]:
                  - generic [ref=e215]: C:\xampp\htdocs\vellor\admin\resources\views\admin\tenants\audit\index.blade.php
                  - generic [ref=e216]: :25
      ...
      - generic [ref=e896]:
        ...
        - generic [ref=e899]:
          - generic [ref=e900]:
            ...
            - code [ref=e904]: App\Http\Controllers\Admin\Tenant\AdminTenantAuditController@index
          - generic [ref=e905]:
            - generic [ref=e906] [cursor=pointer]: route name
            - code [ref=e909]: admin.tenants.audit.index
          - generic [ref=e910]:
        ...
        - generic [ref=e922]:
          - generic [ref=e923]:
            - generic [ref=e924]:
              - text: mysql
              - generic [ref=e925]: (3.38 ms)
            - code [ref=e928]: "select * from `users` where `id` = 1 and `users`.`deleted_at` is null limit 1"
          - generic [ref=e929]:
            - generic [ref=e930]:
              - text: mysql
              - generic [ref=e931]: (0.8 ms)
            - code [ref=e934]: "select * from `salons` where `salons`.`id` = 2 limit 1"
          - generic [ref=e935]:
            - generic [ref=e936]:
              - text: mysql
              - generic [ref=e937]: (16.6 ms)
            - code [ref=e940]: "insert into `audit_logs` (`user_id`, `user_email`, `user_name`, `salon_id`, `event`, `event_category`, `severity`, `description`, `subject_type`, `subject_id`, `metadata`, `ip_address`, `user_agent`, `session_id`, `request_id`, `http_method`, `url`, `occurred_at`) values (1, 'admin@velour.app', 'Velour Admin', 2, 'admin.tenant.view', 'admin', 'warning', 'Admin viewed audit.index list for salon 'ak salon'', 'App\\Models\\Salon', 2, '{\"module\":\"audit.index\",\"salon_id\":2}', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.7922.34 Safari/537.36', 'EVylLVZnikIxF2MdWsshwm23DmppHzyCjf8oYXN1', NULL, 'GET', 'http://localhost/admin/tenants/2/audit', '2026-08-09 12:38:13')"
          - generic [ref=e941]:
            - generic [ref=e942]:
              - text: mysql
              - generic [ref=e943]: (1.86 ms)
            - code [ref=e946]: "select count(*) as aggregate from `audit_logs` where `salon_id` = 2"
          - generic [ref=e947]:
            - generic [ref=e948]:
              - text: mysql
              - generic [ref=e949]: (0.89 ms)
            - code [ref=e952]: "select * from `audit_logs` where `salon_id` = 2 order by `occurred_at` desc limit 30 offset 0"
          - generic [ref=e953]:
            - generic [ref=e954]:
              - text: mysql
              - generic [ref=e955]: (1.01 ms)
          ...
          - generic [ref=e1025]:
            - generic [ref=e1026]:
              - text: mysql
              - generic [ref=e1027]: (1.93 ms)
            - code [ref=e1030]: "select * from `users` where `users`.`id` = 5 and `users`.`deleted_at` is null limit 1"
          - generic [ref=e1031]:
            - generic [ref=e1032]:
              - text: mysql
              - generic [ref=e1033]: (0.82 ms)
          ...
          - generic [ref=e1037]:
            - generic [ref=e1038]:
              - text: mysql
              - generic [ref=e1039]: (0.91 ms)
            - code [ref=e1042]: "select `salon_id` from `staff` where `user_id` = 1 and `deleted_at` is null limit 1"
          - generic [ref=e1043]:
            - generic [ref=e1044]:
              - text: mysql
              - generic [ref=e1045]: (0.9 ms)
            - code [ref=e1048]: "select count(*) as aggregate from `support_tickets` where `status` in ('open', 'in_progress') and `assigned_to` is null"
          - generic [ref=e1049]:
            - generic [ref=e1050]:
              - text: mysql
