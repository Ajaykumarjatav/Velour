...
- Name: admin-pages.spec.ts >> Super Admin pages (plan SA-*) >> SA-09g GET /admin/tenants/2/expenses
- Location: tests\playwright\admin-pages.spec.ts:44:5

# Error details

```
Error: SA-09g admin/tenants/2/expenses status
  ...
  - main [ref=e16]:
    - generic [ref=e17]:
      ...
      - generic [ref=e810]:
        ...
        - generic [ref=e812]: GET /admin/tenants/2/expenses
      ...
      - generic [ref=e896]:
        ...
        - generic [ref=e899]:
          - generic [ref=e900]:
            ...
            - code [ref=e904]: App\Http\Controllers\Admin\Tenant\AdminTenantExpenseController@index
          - generic [ref=e905]:
            - generic [ref=e906] [cursor=pointer]: route name
            - code [ref=e909]: admin.tenants.expenses.index
          - generic [ref=e910]:
        ...
        - generic [ref=e922]:
          - generic [ref=e923]:
            - generic [ref=e924]:
              - text: mysql
              - generic [ref=e925]: (3.21 ms)
            - code [ref=e928]: "select * from `users` where `id` = 1 and `users`.`deleted_at` is null limit 1"
          - generic [ref=e929]:
            - generic [ref=e930]:
              - text: mysql
              - generic [ref=e931]: (1.03 ms)
            - code [ref=e934]: "select * from `salons` where `salons`.`id` = 2 limit 1"
          - generic [ref=e935]:
            - generic [ref=e936]:
              - text: mysql
              - generic [ref=e937]: (13.12 ms)
            - code [ref=e940]: "insert into `audit_logs` (`user_id`, `user_email`, `user_name`, `salon_id`, `event`, `event_category`, `severity`, `description`, `subject_type`, `subject_id`, `metadata`, `ip_address`, `user_agent`, `session_id`, `request_id`, `http_method`, `url`, `occurred_at`) values (1, 'admin@velour.app', 'Velour Admin', 2, 'admin.tenant.view', 'admin', 'warning', 'Admin viewed expenses.index list for salon 'ak salon'', 'App\\Models\\Salon', 2, '{\"module\":\"expenses.index\",\"salon_id\":2}', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.7922.34 Safari/537.36', 'EVylLVZnikIxF2MdWsshwm23DmppHzyCjf8oYXN1', NULL, 'GET', 'http://localhost/admin/tenants/2/expenses', '2026-08-09 12:37:01')"
          - generic [ref=e941]:
            - generic [ref=e942]:
              - text: mysql
              - generic [ref=e943]: (2.13 ms)
            - code [ref=e946]: "select count(*) as aggregate from `expenses` where `salon_id` = 2 and `status` = 'recorded'"
          - generic [ref=e947]:
            - generic [ref=e948]:
              - text: mysql
              - generic [ref=e949]: (4.93 ms)
          ...
          - generic [ref=e989]:
            - generic [ref=e990]:
              - text: mysql
              - generic [ref=e991]: (12.13 ms)
            - code [ref=e994]: "select `salon_id` from `staff` where `user_id` = 1 and `deleted_at` is null limit 1"
          - generic [ref=e995]:
            - generic [ref=e996]:
              - text: mysql
              - generic [ref=e997]: (15.43 ms)
            - code [ref=e1000]: "select * from `users` where `users`.`id` = 5 and `users`.`deleted_at` is null limit 1"
          - generic [ref=e1001]:
            - generic [ref=e1002]:
              - text: mysql
              - generic [ref=e1003]: (16.33 ms)
          ...
          - generic [ref=e1007]:
            - generic [ref=e1008]:
              - text: mysql
              - generic [ref=e1009]: (12.84 ms)
            - code [ref=e1012]: "select `salon_id` from `staff` where `user_id` = 1 and `deleted_at` is null limit 1"
          - generic [ref=e1013]:
            - generic [ref=e1014]:
              - text: mysql
              - generic [ref=e1015]: (1.24 ms)
            - code [ref=e1018]: "select count(*) as aggregate from `support_tickets` where `status` in ('open', 'in_progress') and `assigned_to` is null"
          - generic [ref=e1019]:
            - generic [ref=e1020]:
              - text: mysql
              - generic [ref=e1021]: (3.72 ms)
